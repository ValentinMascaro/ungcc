...
postfix_expression
        ...
        | postfix_expression '(' argument_expression_list ')' 
        {
               if(!(strcmp($1->type_symbol,"PTR")))
                ...
                snprintf(buf,256,"%s",$1->label);
                char* buf2 = malloc(256);
                char* copy2 = malloc(256);
                snprintf(buf2,256,"%s",$1->type_symbol);
                strcpy(copy,buf);
                strcpy(copy2,buf2);
                $$=creer_symbole(copy,copy2);
               
                
                $$->nb_param=-1;
                if(!(strcmp($$->type_symbol,"PTR")))
                {
                        ...
                        snprintf(buf3,256,"%s",$1->contenu_adresse->label);
                       
                        strcpy(copy3,buf3);
                        char* buf4 = malloc(256);
                        char* copy4 = malloc(256);
                       
                        snprintf(buf4,256,"%s",$1->contenu_adresse->type_symbol);
                       
                        strcpy(copy4,buf4);
                        $$->contenu_adresse = creer_symbole(copy3,copy4);
                        free(buf3);
                        free(buf4);
